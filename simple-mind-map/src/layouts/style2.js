            ...
            if (isRoot) {
                ...
                if(parent._node.isRoot)
                {
                    ...
                    if(index==0)
                    {
                        ...
                        newNode.left = parent.children[index-1]._node.left + parent.children[index-1]._node.width+this.getMarginX(layerIndex)
                    }
                }
            }
            if (!cur.data.expand) {
